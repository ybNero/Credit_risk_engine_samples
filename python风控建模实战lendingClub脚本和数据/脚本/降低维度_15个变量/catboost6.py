...
data1#字符串转换为数值型，删除空缺值100%变量
model accuracy is: 0.9901619769494341
model precision is: 0.9575757575757575
model sensitivity is: 0.2981132075471698
f1_score: 0.4546762589928057
AUC: 0.8701937048650183
good classifier
gini 0.7403874097300367


#data2删除信息增益低或0的变量，单一占比高变量，入模型变量99个
...
AUC: 0.8713521300781355
good classifier
gini 0.742704260156271
ks value:0.5869

#分类变量使用，提升效果不明显（移动杯测试，分类变量使用对模型区分能力提升明显）
...
model precision is: 0.9069767441860465
model sensitivity is: 0.2943396226415094
f1_score: 0.44444444444444436
AUC: 0.8703973119886854
good classifier
gini 0.7407946239773708
ks value:0.5837
...
#clf.fit(X_train,y_train,verbose=True,eval_set=eval_dataset)
...
df_feature_importances.to_excel("catboost_15变量信息增益.xlsx")
...
plt.ylabel('Feature')
plt.show()
plt.savefig("featureImportance_15.png")



#保存模型
import pickle
save_classifier = open("catboost6.pickle","wb")
