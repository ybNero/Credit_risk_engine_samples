...
rf.best_params_
Out[69]: {'max_depth': 6, 'num_leaves': 44}
MAE 14.879288153378157
score: 0.0629751151525807
"""
...
rf = GridSearchCV(estimator = model, param_grid = params_test1, n_jobs = -1)
