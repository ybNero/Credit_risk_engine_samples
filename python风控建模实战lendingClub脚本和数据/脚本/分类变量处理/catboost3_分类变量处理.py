...
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9900321877271311
model precision is: 0.95625
model sensitivity is: 0.28867924528301886
f1_score: 0.44347826086956516
AUC: 0.8651012920610106
good classifier
gini 0.7302025841220212
ks value:0.5587
total: 2m  
...
model precision is: 0.9493670886075949
model sensitivity is: 0.2830188679245283
f1_score: 0.43604651162790703
AUC: 0.8622900736064583
good classifier
gini 0.7245801472129165
ks value:0.5467
total: 2m 1s 
"""
...
df_feature_importances.to_excel("catboost_类别处理.xlsx")

n_features=X.shape[1]
plt.barh(range(n_features),cb.feature_importances_,align='center')
plt.yticks(np.arange(n_features),X.columns)
plt.title("catboost")
plt.xlabel('Feature Importance_catagoryDealed')
plt.ylabel('Feature')
plt.show()
plt.savefig("featureImportance_类别处理.png")
