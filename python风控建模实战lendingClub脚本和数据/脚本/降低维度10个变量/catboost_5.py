...
catboost官网说明
https://catboost.ai/docs/references/custom-metric__supported-metrics.html

catboost
accuracy on the training subset:0.991
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9901100612605129
model precision is: 0.9685534591194969
model sensitivity is: 0.29056603773584905
f1_score: 0.44702467343976776
AUC: 0.8667047229900251
good classifier
gini 0.7334094459800502
ks value:0.5637
-----------------------------------------------------------
eval_metric测试
...
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9900581455715918
model precision is: 0.9565217391304348
model sensitivity is: 0.29056603773584905
f1_score: 0.4457308248914617
AUC: 0.8661339774601947
good classifier
gini 0.7322679549203894
ks value:0.5580

cb = cb.CatBoostClassifier(eval_metric='F1')
accuracy on the training subset:0.992
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9900062298826705
model precision is: 0.9289940828402367
model sensitivity is: 0.2962264150943396
f1_score: 0.4492131616595136
AUC: 0.8642576136649183
good classifier
gini 0.7285152273298365
ks value:0.5602

cb = cb.CatBoostClassifier(eval_metric='Precision')
accuracy on the training subset:0.987
accuracy on the test subset:0.987
test data:
model accuracy is: 0.9871508669920049
model precision is: 1.0
model sensitivity is: 0.0660377358490566
f1_score: 0.1238938053097345
AUC: 0.7835853923310632
good classifier
gini 0.5671707846621263
ks value:0.4142

cb = cb.CatBoostClassifier(eval_metric='Recall')
accuracy on the training subset:0.992
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9900062298826705
...
cb = cb.CatBoostClassifier(eval_metric='Logloss')
accuracy on the training subset:0.991
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9900841034160524
model precision is: 0.9743589743589743
model sensitivity is: 0.28679245283018867
f1_score: 0.44314868804664714
AUC: 0.8630174973009641
good classifier
gini 0.7260349946019282
ks value:0.5594

cb = cb.CatBoostClassifier(eval_metric='Accuracy')
accuracy on the training subset:0.990
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9901360191049735
model precision is: 0.9807692307692307
model sensitivity is: 0.28867924528301886
f1_score: 0.446064139941691
AUC: 0.8574760314687225
good classifier
gini 0.7149520629374451
ks value:0.5499
----------------------------------------
iteration测试
cb = cb.CatBoostClassifier(iterations=1000)
accuracy on the training subset:0.991
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9901100612605129
...
cb = cb.CatBoostClassifier(iterations=500)
accuracy on the training subset:0.991
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9898764406603676
model precision is: 0.9375
model sensitivity is: 0.2830188679245283
f1_score: 0.4347826086956522
AUC: 0.8671720509991151
good classifier
gini 0.7343441019982302
ks value:0.5595
total: 23.1s 

cb = cb.CatBoostClassifier(iterations=100)
accuracy on the training subset:0.990
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9899283563492888
model precision is: 0.9382716049382716
model sensitivity is: 0.28679245283018867
f1_score: 0.4393063583815029
AUC: 0.8558973810164664
good classifier
gini 0.7117947620329328
ks value:0.5427
total: 2.52s  

cb = cb.CatBoostClassifier(iterations=10000)
accuracy on the training subset:0.992
accuracy on the test subset:0.990
test data:
model accuracy is: 0.9899802720382099
model precision is: 0.95
model sensitivity is: 0.28679245283018867
f1_score: 0.4405797101449275
AUC: 0.8700904363251
good classifier
gini 0.7401808726501999
ks value:0.5616
total: 7m 59s
"""
import time
...
readFileName="data_Q4_filter.xlsx"
#读取excel
...
cb.fit(train_x,y_train,verbose=True)
#eval_dataset=(test_x,y_test)
#cb.fit(train_x,y_train,eval_set=eval_dataset,plot=True)
...
df_feature_importances.to_excel("catboost_20变量信息增益.xlsx")
...
plt.ylabel('Feature')
plt.show()
plt.savefig("featureImportance_10.png")
