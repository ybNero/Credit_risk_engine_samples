...
readFileName=r"G:\My Drive\Projects\Credit risk engine\python Credit risk model lendingClub - initial\data1.xlsx"
#删除信息增益低或0的变量，单一占比高变量，入模型变量99个
#读取excel
data=pd.read_excel(readFileName)
#字符串转换为数值型，删除空缺值100%变量
X=data.loc[:,"loan_amnt":"debt_settlement_flag"]
y=data["target"]
